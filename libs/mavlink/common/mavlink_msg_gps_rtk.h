#ifndef MAVLINK_CPP_MSG_GPS_RTK_H
#define MAVLINK_CPP_MSG_GPS_RTK_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t gps_rtk_id = 127;
    const uint8_t gps_rtk_length = 35;
    const uint8_t gps_rtk_crc = 25;
...
#endif //MAVLINK_CPP_MSG_GPS_RTK_H
