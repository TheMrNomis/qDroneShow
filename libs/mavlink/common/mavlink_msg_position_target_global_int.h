#ifndef MAVLINK_CPP_MSG_POSITION_TARGET_GLOBAL_INT_H
#define MAVLINK_CPP_MSG_POSITION_TARGET_GLOBAL_INT_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t position_target_global_int_id = 87;
    const uint8_t position_target_global_int_length = 51;
    const uint8_t position_target_global_int_crc = 150;
...
#endif //MAVLINK_CPP_MSG_POSITION_TARGET_GLOBAL_INT_H
