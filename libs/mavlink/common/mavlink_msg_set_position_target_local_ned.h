#ifndef MAVLINK_CPP_MSG_SET_POSITION_TARGET_LOCAL_NED_H
#define MAVLINK_CPP_MSG_SET_POSITION_TARGET_LOCAL_NED_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t set_position_target_local_ned_id = 84;
    const uint8_t set_position_target_local_ned_length = 53;
    const uint8_t set_position_target_local_ned_crc = 143;
...
#endif //MAVLINK_CPP_MSG_SET_POSITION_TARGET_LOCAL_NED_H
