#ifndef MAVLINK_CPP_MSG_VICON_POSITION_ESTIMATE_H
#define MAVLINK_CPP_MSG_VICON_POSITION_ESTIMATE_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t vicon_position_estimate_id = 104;
    const uint8_t vicon_position_estimate_length = 32;
    const uint8_t vicon_position_estimate_crc = 56;

    class vicon_position_estimate : public mavlink::message
    {
      public:
        vicon_position_estimate(uint8_t system_id, uint8_t component_id,  uint64_t usec, float x, float y, float z, float roll, float pitch, float yaw):
          mavlink::message( mavlink::msg::vicon_position_estimate_length,
                            system_id,
                            component_id,
                            mavlink::msg::vicon_position_estimate_id,
                            mavlink::msg::vicon_position_estimate_crc)
        {
...
#endif //MAVLINK_CPP_MSG_VICON_POSITION_ESTIMATE_H
