#ifndef MAVLINK_CPP_MSG_SCALED_IMU_H
#define MAVLINK_CPP_MSG_SCALED_IMU_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t scaled_imu_id = 26;
    const uint8_t scaled_imu_length = 22;
    const uint8_t scaled_imu_crc = 170;
...
#endif //MAVLINK_CPP_MSG_SCALED_IMU_H
