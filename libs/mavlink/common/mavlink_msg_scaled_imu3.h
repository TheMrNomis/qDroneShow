#ifndef MAVLINK_CPP_MSG_SCALED_IMU3_H
#define MAVLINK_CPP_MSG_SCALED_IMU3_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t scaled_imu3_id = 129;
    const uint8_t scaled_imu3_length = 22;
    const uint8_t scaled_imu3_crc = 46;

    class scaled_imu3 : public mavlink::message
    {
      public:
        scaled_imu3(uint8_t system_id, uint8_t component_id,  uint32_t time_boot_ms, int16_t xacc, int16_t yacc, int16_t zacc, int16_t xgyro, int16_t ygyro, int16_t zgyro, int16_t xmag, int16_t ymag, int16_t zmag):
          mavlink::message( mavlink::msg::scaled_imu3_length,
                            system_id,
                            component_id,
                            mavlink::msg::scaled_imu3_id,
                            mavlink::msg::scaled_imu3_crc)
        {
...
#endif //MAVLINK_CPP_MSG_SCALED_IMU3_H
