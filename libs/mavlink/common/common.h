 ...
 */
#ifndef MAVLINK_CPP_COMMON_H
#define MAVLINK_CPP_COMMON_H

#ifndef MAVLINK_CPP_H
    #error Wrong include order: MAVLINK_COMMON.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_CPP_H call.
#endif
