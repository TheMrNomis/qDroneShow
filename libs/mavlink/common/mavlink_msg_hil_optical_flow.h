#ifndef MAVLINK_CPP_MSG_HIL_OPTICAL_FLOW_H
#define MAVLINK_CPP_MSG_HIL_OPTICAL_FLOW_H
...
namespace mavlink
{
  namespace msg
  {
    const uint8_t hil_optical_flow_id = 114;
    const uint8_t hil_optical_flow_length = 44;
    const uint8_t hil_optical_flow_crc = 237;
...
#endif //MAVLINK_CPP_MSG_HIL_OPTICAL_FLOW_H
